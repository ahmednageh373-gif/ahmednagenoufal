...
export const projectTemplates: ProjectTemplate[] = [
    ...
    },
    {
        ...
        data: {
            ...
            schedule: [
                { id: 1, name: 'التصميمات والترخيص', start: '2024-08-01', end: '2024-08-30', progress: 100, dependencies: [], category: 'Planning', status: 'Done', priority: 'High', assignees: ['AD'] },
                { id: 2, name: 'أعمال الحفر والأساسات', start: '2024-09-01', end: '2024-09-20', progress: 50, dependencies: [1], category: 'Foundation', status: 'In Progress', priority: 'High', assignees: ['CE'] },
                { id: 3, name: 'الهيكل الخرساني', start: '2024-09-21', end: '2024-11-10', progress: 0, dependencies: [2], category: 'Structure', status: 'To Do', priority: 'High', assignees: ['CE'] },
            ],
            financials: [
